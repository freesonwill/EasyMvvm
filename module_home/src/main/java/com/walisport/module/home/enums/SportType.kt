...
enum class SportType(val id: Int, @StringRes val titleResId: Int, val iconResActive: Int, val iconResInactive: Int) {
    Soccer(1, R.string.tittle_soccer, R.drawable.ic_soccer_active, R.drawable.ic_soccer_inactive),
    VOLLEYBALL(2, R.string.tittle_volleyball, R.drawable.ic_volleyball_active, R.drawable.ic_volleyball_inactive),
    BASKETBALL(3, R.string.tittle_basketball, R.drawable.ic_basketball_active, R.drawable.ic_basketball_inactive),
    FOOTBALL(4, R.string.tittle_football, R.drawable.ic_football_active, R.drawable.ic_football_inactive),
    BASEBALL(5, R.string.tittle_baseball, R.drawable.ic_baseball_active, R.drawable.ic_baseball_inactive),
//    // 🔽 其他運動類型（共 24 種）
