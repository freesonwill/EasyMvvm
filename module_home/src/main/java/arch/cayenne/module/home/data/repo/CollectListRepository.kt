...
class CollectListRepository(
    ...
    @Transaction
    suspend fun removeMatchCollect(item: MatchWithMarkets): Boolean {
        val res = socketManager.sendAndWaitProtoMessageResponse<Client.RemoveCollectReq>(
            scope = scope,
            dispatcher = Dispatchers.IO,
        ...
        if (res.error == null && res.data != null) {
            matchDao.updateOnlyMatchCollect(item.match.matchId, false)
