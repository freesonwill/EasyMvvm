...
class HomeModuleInitializer: DefaultInitializer<Unit> {
    ...
    private val viewModules = module {
        ...
        viewModel { arch.cayenne.module.home.viewmodel.DrawerContentViewModel() }
        viewModel { arch.cayenne.module.home.viewmodel.HomeViewModel() }
        viewModel { arch.cayenne.module.home.viewmodel.MatchListViewModel() }
    }
