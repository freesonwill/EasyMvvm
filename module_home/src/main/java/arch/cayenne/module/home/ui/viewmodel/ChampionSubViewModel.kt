    ...
    override fun initViewModel() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            sportTrigger
                ...
                .collect {
                    "联赛资料  collect ".logi(this@ChampionSubViewModel::class.java.simpleName)
                    if (currentPlayTypeId != PlayType.CHAMPION.id) {
                        ...
                        if (selectedTournament == null) {
                            "联赛资料 setCurrentTournamentId(0) ".logi(this@ChampionSubViewModel::class.java.simpleName)
                        ...
                        launch(Dispatchers.Main) {
                            "送出联赛资料到UI".logi(this@ChampionSubViewModel::class.java.simpleName)
                            tournaments.value =
    ...
    fun getCurrentTournament() {
        viewModelScope.launch {
            ...
            callApi({
                ...
                if (it is ApiResponseState.Succeeded<*>) {
                    "联赛资料 存入DB完成 ".logi(this@ChampionSubViewModel::class.java.simpleName)
                    setState(HomeState.Tournament.LoadSuccess)
                } else if (it is ApiResponseState.Failed) {
                    if ((tournaments.value?.peekContent() == null || tournaments.value?.peekContent()
                            ?.isEmpty() == true)
