...
-keep class com.cn.game.sdk.bean.**{ *; }
-keep class com.cn.game.sdk.utils.**{ *; }
-keep class com.cn.game.sdk.view.**{ *; }
-keep class com.cn.game.sdk.event.**{ *; }
-keep class com.cn.game.sdk.websocket.bean.**{ *; }
-keep class com.xcjh.base_lib.network.BaseResponse { *; }
-keep class com.xcjh.base_lib.**{ *; }
-keep class com.xcjh.base_lib.utils .**{ *; }
