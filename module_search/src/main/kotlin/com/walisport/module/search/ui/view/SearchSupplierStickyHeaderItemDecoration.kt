...
/**
 * Search 模組專用的 Sticky Header ItemDecoration，用於 BottomSheet。
 * 與 hall 模組的 SupplierStickyHeaderItemDecoration 對應，但完全獨立實作。
 */
class SearchSupplierStickyHeaderItemDecoration(
