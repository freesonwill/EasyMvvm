...
open class FlowLayout @JvmOverloads constructor(
     ...
     * 折叠行数
     */
      var mFoldLines = DEFAULT_FOLD_LINES
     ...
     * 是否平均
     */
    private val mEqually: Boolean

    /**
     * 一行平局数量
     */
    private val mEquallyCount: Int
    ...
    init {
        ...
        mHorizontalSpacing =
            a.getDimensionPixelOffset(R.styleable.FlowLayout_flow_horizontalSpacing, dp2px(4))
        mVerticalSpacing =
            a.getDimensionPixelOffset(R.styleable.FlowLayout_flow_verticalSpacing, dp2px(4))
        a.recycle()
    }
        ...
        for (i in 0 until count) {
            ...
            if (mEqually) {
                ...
                if (wh == null) {
                    ...
                    //求一行能显示多少个
                    var oneRowItemCount =
                        (layoutWidth + mHorizontalSpacing) / (mHorizontalSpacing + wh[0])
                    //当你设置了一行平局显示多少个
                    if (mEquallyCount > 0) {
                    ...
                    val newWidth =
                        (layoutWidth - (oneRowItemCount - 1) * mHorizontalSpacing) / oneRowItemCount
                    wh[0] = newWidth
    ...
    private val maxWidthHeight: IntArray
        /**
         * 取最大的子view的宽度和高度
         *
         * @return
        ...
        get() {
            ...
            while (i < count) {
                ...
                maxWidth =
                    max(maxWidth.toDouble(), view.measuredWidth.toDouble()).toInt()
                maxHeight =
                    max(maxHeight.toDouble(), view.measuredHeight.toDouble()).toInt()
                i++
            }
    ...
    fun interface OnFoldChangedListener {
        /**
         * 折叠状态时时回调
         *
    ...
    companion object {
         ...
         * 默认折叠状态
         */
        private const val DEFAULT_FOLD = false

        /**
         * 折叠的行数
         */
        private const val DEFAULT_FOLD_LINES = 1

        /**
         * 左对齐
         */
        private const val DEFAULT_GRAVITY_LEFT = 0

        /**
         * 右对齐
         */
        private const val DEFAULT_GRAVITY_RIGHT = 1
    }
}
