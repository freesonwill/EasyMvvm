...
import com.walisport.module.topup.databinding.FragmentDatePickerBinding
...
class DatePickerFragment private constructor() :
    ...
    companion object {
        ...
        fun find(
            fragment: Fragment,
            defaultDate: DateFilterEnum? = null,
    ...
    private fun setDate(defaultDate: DateFilterEnum, customTime: Long? = null) {
        if (defaultDate == DateFilterEnum.CUSTOM) {
            if (customTime != null) {
