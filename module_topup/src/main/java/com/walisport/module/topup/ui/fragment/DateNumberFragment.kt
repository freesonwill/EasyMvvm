...
import com.walisport.module.topup.databinding.FragmentDateNumberBinding
...
class DateNumberFragment: BasePreLoadBottomSheetFragment<DateNumberViewModel, FragmentDateNumberBinding>() {
    ...
    private var direction = DatePickerFragment.Direction.TIME
    ...
    override fun initListener() {
        mBinding.tvCancel.setOnClickListener {
            parentFragment?.let { parentFragment ->
                getHideAnimator()?.let { animator ->
                    direction = DatePickerFragment.Direction.DATE
        ...
        mBinding.tvConfirm.setOnClickListener {
            parentFragment?.let { parentFragment ->
                ...
                bundle.apply {
                    putString(Config.VALUE_SELECTED_DATE, DateFilterEnum.CUSTOM.name)
    ...
    override fun setCustomExpendSetting() {
        ...
        arguments = null
        direction = DatePickerFragment.Direction.TIME
    }

    override fun customHide() {
        if (arguments == null && direction == DatePickerFragment.Direction.TIME) {
            parentFragment?.parentFragmentManager?.setFragmentResult(Config.KEY_RESULT, Bundle())
        }
        super.customHide()
    }
