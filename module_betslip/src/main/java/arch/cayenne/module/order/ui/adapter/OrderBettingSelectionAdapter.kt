...
class OrderBettingSelectionAdapter(private val type: OrderSportPageEnum?): BaseAdapter<BetSlipSelectionData, BaseViewHolder, ItemOrderSportBettingSelectionBinding>(
