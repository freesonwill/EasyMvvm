...
import arch.cayenne.module.order.ui.fragment.OrderSportReservePageFragment
...
enum class OrderSportPageEnum(val value: Int, val page: PagerBean) {
    ...
    RESERVE(5, PagerBean(R.string.title_order_sport_reserve.getString()) { OrderSportReservePageFragment() })
}