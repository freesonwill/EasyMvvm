...
public class LoadProgressDialog extends Dialog {
    ...
    private void initView1() {
        setContentView(com.xcjh.tpInfo.R.layout.loading);
        ImageView img = findViewById(com.xcjh.tpInfo.R.id.loadImgView);
        img.setImageResource(com.xcjh.tpInfo.R.drawable.chat_gif_loading);
