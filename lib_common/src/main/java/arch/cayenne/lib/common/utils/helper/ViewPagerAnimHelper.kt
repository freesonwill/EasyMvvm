...
class ViewPagerAnimHelper {
    ...
    private var newHomeViewPagerAnimJob: Job? = null

    fun doNewHomeViewPagerAnim(
        targetPosition: Int,
        viewPager: ViewPager2,
        fakeViewPager: ImageView
    ) {
        newHomeViewPagerAnimJob?.cancel()
        ...
        newHomeViewPagerAnimJob = scope.launch {
