...
public class RippleView extends SkinnableConstraintLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, getResources().getColor(R.color.color_ripper));
        rippleType = typedArray.getInt(R.styleable.RippleView_rv_type, 0);
        bgType = typedArray.getInt(R.styleable.RippleView_rv_bgType, 0);
    ...
    public void draw(Canvas canvas) {
        ...
        if (animationRunning) {
            ...
            if (bgType == 0) {
                path.addRoundRect(rect, 36, 36, Path.Direction.CW);
            } else if (bgType == 1) {
                path.addRoundRect(rect, new float[]{36, 36, 36, 36, 0, 0, 0, 0}, Path.Direction.CW);
            } else if (bgType == 2) {
                path.addRect(new RectF(0, 0, WIDTH, HEIGHT), Path.Direction.CW);
            } else {
                path.addRoundRect(rect, new float[]{0, 0, 0, 0, 36, 36, 36, 36}, Path.Direction.CW);
            }
