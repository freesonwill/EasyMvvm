...
class CurrencyAdapter(val listener: ((BaseCurrencyData.CurrencyContentData) -> Unit)? = null): BaseAdapter<BaseCurrencyData, BaseViewHolder, ViewBinding>(CurrencyCompare()) {
