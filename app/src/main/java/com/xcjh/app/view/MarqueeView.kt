...
class MarqueeView : View, Choreographer.FrameCallback {
    ...
    private fun initFadingShader() {
        ...
        mLeftFadingShader=  LinearGradient(
            0f,
            (height / 2).toFloat(),
            fadingLength.toFloat(),
            (height / 2).toFloat(),
            Color.parseColor("#00000000"), // 设置为单一颜色
            Color.parseColor("#00000000"), // 设置为单一颜色
            Shader.TileMode.CLAMP
        )
        mRightFadingShader=LinearGradient(width.toFloat(), (height / 2).toFloat(), (width - fadingLength).toFloat(), (height / 2).toFloat(), Color.parseColor("#00000000"), Color.parseColor("#00000000"), Shader.TileMode.CLAMP)
