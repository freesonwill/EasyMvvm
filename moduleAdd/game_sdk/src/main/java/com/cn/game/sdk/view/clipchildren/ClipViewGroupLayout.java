package com.cn.game.sdk.view.clipchildren;
...
public class ClipViewGroupLayout extends LinearLayout {
    public ClipViewGroupLayout(Context context) {
        super(context);
    }

    public ClipViewGroupLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
