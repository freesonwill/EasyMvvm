...
import com.cn.game.sdk.databinding.FragmentMyBinding
...
class MyGameFragment : BaseGameFragment<MyGameViewModel, FragmentMyBinding>() {
    companion object {
        fun newInstance(
            popup: MyGamePopupDialog
        ) = MyGameFragment().apply {
            myGamePopup = popup
        }
    }

    private var myGamePopup: MyGamePopupDialog? = null
...
//        PromptSoundPlay.goldPlayMediaNew(this)
        ...
        if (finallyView != null) {
            ...
            viewX = location[0] + finallyView!!.width / 2 - requireContext().dp2px(25)
            viewY = location[1]
            ...
            val params =
                RelativeLayout.LayoutParams(requireContext().dp2px(32), requireContext().dp2px(32))
...
//        val toY = (endLoc[1] - parentLocation[1]).toFloat()
            ...
            val toY = endLoc[1].toFloat() - requireContext().dp2px(35)
...
//        path.quadTo((startX + toX) / 2, startY, toX, toY)
            ...
            valueAnimator.addListener(object : Animator.AnimatorListener {
                ...
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    val animator =
                        ObjectAnimator.ofPropertyValuesHolder(animationView, SCALE_X, SCALE_Y)
...
//        二、计算动画开始/结束点的坐标的准备工作
                ...
                val endLoc = IntArray(2)
                if (isCentered) {
                    endLoc[0] = x.toInt() - requireContext().dp2px(10)
...
//             }
    ...
    fun scrollToItemAndPerformAction(
