...
class SumTotalFragment : BaseGameFragment<SumTotalVm, FragmentSumTotalBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        showSumShiQiMoney.setMoneyOKClickListener(
            MoneyOkClickListener(mDatabind.rvSumClickFour, showSumShiQiMoney)
        )
...
//        })
    ...
    inner class MoneyOkClickListener(
        private val parentLayout: RelativeLayout, private val moneyView: MoneyOKView
    ) : MoneyOKView.OnMoneyOKClickListener {
        override fun onDelete() {
            if (ComputeSingle.singleYi.moneyOkEmpty <= 0) {
                //判断控件是否加入了
                if (parentLayout.indexOfChild(moneyView) != -1) {
                    parentLayout.removeView(moneyView)
                }
            }
            homeXPopupDialog.clickDelete()
        }
     ...
     */
    fun fadeOut(
        isAnimation: Boolean, inPrizeList: ArrayList<InPrizeBean> = ArrayList<InPrizeBean>()
    ) {
        if (isAnimation) {
            inPrizeList.forEach {
                if (it.inPrizType == NOTES_ENUM.GQTNumber4.num) {
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashSi, "alpha", 1f, 0f, 1f
                    ).apply {
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashWu, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashLiu, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashQi, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashBa, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashJiu, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashShi, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashShiYi, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashShiEr, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashShiSan, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashShiSi, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashShiWu, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashShiLiu, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
                    ...
                    animators.add(ObjectAnimator.ofFloat(
                        mDatabind.ivSumFlashShiQi, "alpha", 1f, 0f, 1f
                    ).apply {
                        duration = 400 // 设置动画持续时间
                        repeatCount = ObjectAnimator.INFINITE // 设置无限循环
                        repeatMode = ObjectAnimator.REVERSE // 设置反向循环以实现渐隐渐显效果
    ...
    fun flicker(inPrizeList: ArrayList<InPrizeBean>, pressureIn: ArrayList<InPrizeBean>) {
        ...
        for (i in 0 until pressureIn.size) {
            if (pressureIn[i].inPrizType == NOTES_ENUM.GQTNumber4.num) {
                ...
                showSumShiYiMoney.translationX =
                    ComputeSum.sumTotalShiYi.viewXYTemporary[0].toFloat()
                showSumShiYiMoney.translationY =
                    ComputeSum.sumTotalShiYi.viewXYTemporary[1].toFloat()
                ...
                showSumShiErMoney.translationX =
                    ComputeSum.sumTotalShiEr.viewXYTemporary[0].toFloat()
                showSumShiErMoney.translationY =
                    ComputeSum.sumTotalShiEr.viewXYTemporary[1].toFloat()
                ...
                showSumShiSanMoney.translationX =
                    ComputeSum.sumTotalShiSan.viewXYTemporary[0].toFloat()
                showSumShiSanMoney.translationY =
                    ComputeSum.sumTotalShiSan.viewXYTemporary[1].toFloat()
                ...
                showSumShiSiMoney.translationX =
                    ComputeSum.sumTotalShiSi.viewXYTemporary[0].toFloat()
                showSumShiSiMoney.translationY =
                    ComputeSum.sumTotalShiSi.viewXYTemporary[1].toFloat()
                ...
                showSumShiWuMoney.translationX =
                    ComputeSum.sumTotalShiWu.viewXYTemporary[0].toFloat()
                showSumShiWuMoney.translationY =
                    ComputeSum.sumTotalShiWu.viewXYTemporary[1].toFloat()
                ...
                showSumShiLiuMoney.translationX =
                    ComputeSum.sumTotalShiLiu.viewXYTemporary[0].toFloat()
                showSumShiLiuMoney.translationY =
                    ComputeSum.sumTotalShiLiu.viewXYTemporary[1].toFloat()
                ...
                showSumShiQiMoney.translationX =
                    ComputeSum.sumTotalShiQi.viewXYTemporary[0].toFloat()
                showSumShiQiMoney.translationY =
                    ComputeSum.sumTotalShiQi.viewXYTemporary[1].toFloat()
            }
...
//                            ComputeSum.sumTotalWu.viewXYTemporary[0]=rax.toInt()
                            ComputeSum.sumTotalSi.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickFour.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalSi.viewXYTemporary[1] =
                                newY.toInt() - requireContext().dp2px(52)
                        }
                        ...
                        //计算钱
                        ComputeSum.sumTotalSi.moneyTemporary =
                            ComputeSum.sumTotalSi.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumSiMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumSiMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    ...
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumSiMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumSiMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                            ...
                            mDatabind.rlHomeRoot.addView(showSumSiMoney, params)
                            showSumSiMoney.translationX =
                                ComputeSum.sumTotalSi.viewXYTemporary[0].toFloat()
                            showSumSiMoney.translationY =
                                ComputeSum.sumTotalSi.viewXYTemporary[1].toFloat()
...
//                            ComputeSum.sumTotalWu.viewXYTemporary[0]=rax.toInt()
                            ComputeSum.sumTotalWu.viewXYTemporary[0] =
                                location[0] + mDatabind.vSumClickFive.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalWu.viewXYTemporary[1] =
                                newY.toInt() - requireContext().dp2px(52)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalWu.moneyTemporary =
                            ComputeSum.sumTotalWu.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumWuMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumWuMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumWuMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumWuMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                            ...
                            showSumWuMoney.translationX =
                                ComputeSum.sumTotalWu.viewXYTemporary[0].toFloat()
                            showSumWuMoney.translationY =
                                ComputeSum.sumTotalWu.viewXYTemporary[1].toFloat()
                        }
...
//                            ComputeSum.sumTotalWu.viewXYTemporary[0]=rax.toInt()
                            ComputeSum.sumTotalLiu.viewXYTemporary[0] =
                                location[0] + mDatabind.vSumClickSix.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalLiu.viewXYTemporary[1] =
                                newY.toInt() - requireContext().dp2px(52)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalLiu.moneyTemporary =
                            ComputeSum.sumTotalLiu.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumLiuMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumLiuMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumLiuMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumLiuMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                            ...
                            showSumLiuMoney.translationX =
                                ComputeSum.sumTotalLiu.viewXYTemporary[0].toFloat()
                            showSumLiuMoney.translationY =
                                ComputeSum.sumTotalLiu.viewXYTemporary[1].toFloat()
                        }
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalQi.viewXYTemporary[0] == 0 && ComputeSum.sumTotalQi.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalQi.viewXYTemporary[0] =
                                location[0] + mDatabind.vSumClickSeven.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalQi.viewXYTemporary[1] =
                                newY.toInt() - requireContext().dp2px(52)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalQi.moneyTemporary =
                            ComputeSum.sumTotalQi.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumQiMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumQiMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumQiMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumQiMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                            ...
                            showSumQiMoney.translationX =
                                ComputeSum.sumTotalQi.viewXYTemporary[0].toFloat()
                            showSumQiMoney.translationY =
                                ComputeSum.sumTotalQi.viewXYTemporary[1].toFloat()
                        }
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalBa.viewXYTemporary[0] == 0 && ComputeSum.sumTotalBa.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalBa.viewXYTemporary[0] =
                                location[0] + mDatabind.vSumClickEight.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalBa.viewXYTemporary[1] =
                                newY.toInt() - requireContext().dp2px(52)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalBa.moneyTemporary =
                            ComputeSum.sumTotalBa.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumBaMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumBaMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumBaMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumBaMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                            ...
                            showSumBaMoney.translationX =
                                ComputeSum.sumTotalBa.viewXYTemporary[0].toFloat()
                            showSumBaMoney.translationY =
                                ComputeSum.sumTotalBa.viewXYTemporary[1].toFloat()
                        }
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalJiu.viewXYTemporary[0] == 0 && ComputeSum.sumTotalJiu.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalJiu.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickNine.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalJiu.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(8)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                            if (MyGameManager.noteList[i].select) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalJiu.moneyTemporary =
                            ComputeSum.sumTotalJiu.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumJiuMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumJiuMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumJiuMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumJiuMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                            ...
                            showSumJiuMoney.translationX =
                                ComputeSum.sumTotalJiu.viewXYTemporary[0].toFloat()
                            showSumJiuMoney.translationY =
                                ComputeSum.sumTotalJiu.viewXYTemporary[1].toFloat()
                        }
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalShi.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShi.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalShi.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickTen.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalShi.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(8)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalShi.moneyTemporary =
                            ComputeSum.sumTotalShi.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumShiMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumShiMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumShiMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumShiMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                            ...
                            showSumShiMoney.translationX =
                                ComputeSum.sumTotalShi.viewXYTemporary[0].toFloat()
                            showSumShiMoney.translationY =
                                ComputeSum.sumTotalShi.viewXYTemporary[1].toFloat()
                        }
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalShiYi.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiYi.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalShiYi.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickEleven.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalShiYi.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(8)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalShiYi.moneyTemporary =
                            ComputeSum.sumTotalShiYi.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumShiYiMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumShiYiMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumShiYiMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumShiYiMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                                    ...
                                    if (ComputeSum.sumTotalShiYi.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiYi.viewXYTemporary[1] == 0) {
                                        ...
                                        ComputeSum.sumTotalShiYi.viewXYTemporary[0] =
                                            showSumShiYiMoney.left
                                        ComputeSum.sumTotalShiYi.viewXYTemporary[1] =
                                            showSumShiYiMoney.top
                                    }
                                }
                            })
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalShiEr.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiEr.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalShiEr.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickTwelve.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalShiEr.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(8)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalShiEr.moneyTemporary =
                            ComputeSum.sumTotalShiEr.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumShiErMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumShiErMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumShiErMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumShiErMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                                    ...
                                    if (ComputeSum.sumTotalShiEr.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiEr.viewXYTemporary[1] == 0) {
                                        ...
                                        ComputeSum.sumTotalShiEr.viewXYTemporary[0] =
                                            showSumShiErMoney.left
                                        ComputeSum.sumTotalShiEr.viewXYTemporary[1] =
                                            showSumShiErMoney.top
                                    }
                                }
                            })
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalShiSan.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiSan.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalShiSan.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickThirteen.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalShiSan.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(8)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalShiSan.moneyTemporary =
                            ComputeSum.sumTotalShiSan.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumShiSanMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumShiSanMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumShiSanMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumShiSanMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                                    ...
                                    if (ComputeSum.sumTotalShiSan.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiSan.viewXYTemporary[1] == 0) {
                                        ...
                                        ComputeSum.sumTotalShiSan.viewXYTemporary[0] =
                                            showSumShiSanMoney.left
                                        ComputeSum.sumTotalShiSan.viewXYTemporary[1] =
                                            showSumShiSanMoney.top
                                    }
                                }
                            })
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalShiSi.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiSi.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalShiSi.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickFourteen.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalShiSi.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(68)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                            if (MyGameManager.noteList[i].select) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalShiSi.moneyTemporary =
                            ComputeSum.sumTotalShiSi.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumShiSiMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumShiSiMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumShiSiMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumShiSiMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                                    ...
                                    if (ComputeSum.sumTotalShiSi.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiSi.viewXYTemporary[1] == 0) {
                                        ...
                                        ComputeSum.sumTotalShiSi.viewXYTemporary[0] =
                                            showSumShiSiMoney.left
                                        ComputeSum.sumTotalShiSi.viewXYTemporary[1] =
                                            showSumShiSiMoney.top
                                    }
                                }
                            })
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalShiWu.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiWu.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalShiWu.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickFifteen.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalShiWu.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(68)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalShiWu.moneyTemporary =
                            ComputeSum.sumTotalShiWu.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumShiWuMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumShiWuMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumShiWuMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumShiWuMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                                    ...
                                    if (ComputeSum.sumTotalShiWu.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiWu.viewXYTemporary[1] == 0) {
                                        ...
                                        ComputeSum.sumTotalShiWu.viewXYTemporary[0] =
                                            showSumShiWuMoney.left
                                        ComputeSum.sumTotalShiWu.viewXYTemporary[1] =
                                            showSumShiWuMoney.top
                                    }
                                }
                            })
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalShiLiu.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiLiu.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalShiLiu.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickSixteen.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalShiLiu.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(68)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalShiLiu.moneyTemporary =
                            ComputeSum.sumTotalShiLiu.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumShiLiuMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumShiLiuMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumShiLiuMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumShiLiuMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                                    ...
                                    if (ComputeSum.sumTotalShiLiu.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiLiu.viewXYTemporary[1] == 0) {
                                        ...
                                        ComputeSum.sumTotalShiLiu.viewXYTemporary[0] =
                                            showSumShiLiuMoney.left
                                        ComputeSum.sumTotalShiLiu.viewXYTemporary[1] =
                                            showSumShiLiuMoney.top
                                    }
                                }
                            })
...
//                             val adjustedX =    if (x < viewBounds.left) viewBounds.left else if (x > viewBounds.right) viewBounds.right else x
                        ...
                        if (ComputeSum.sumTotalShiQi.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiQi.viewXYTemporary[1] == 0) {
                            ComputeSum.sumTotalShiQi.viewXYTemporary[0] =
                                location[0] + mDatabind.rvSumClickSeventeen.width / 2 - requireContext().dp2px(
                                    30
                                )
                            ComputeSum.sumTotalShiQi.viewXYTemporary[1] =
                                newY.toInt() + requireContext().dp2px(68)
                        }
                        var selectNum = 0
                        for (i in 0 until MyGameManager.noteList.size) {
                        ...
                        //计算钱
                        ComputeSum.sumTotalShiQi.moneyTemporary =
                            ComputeSum.sumTotalShiQi.moneyTemporary + MyGameManager.noteList[selectNum].money
                        ...
                        if (mDatabind.rlHomeRoot.indexOfChild(showSumShiQiMoney) != -1) {
                            ...
                            homeXPopupDialog.startAnimation(
                                rax.toFloat(),
                                ray.toFloat(),
                                animationView = showSumShiQiMoney.ivShowBg
                            )
                            ...
                            viewTreeObserver.addOnGlobalLayoutListener(object :
                                ...
                                override fun onGlobalLayout() {
                                    // 确保只监听一次
                                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                                        showSumShiQiMoney.viewTreeObserver.removeGlobalOnLayoutListener(
                                            this
                                        )
                                    } else {
                                        showSumShiQiMoney.viewTreeObserver.removeOnGlobalLayoutListener(
                                            this
                                        )
                                    }
                                    ...
                                    if (ComputeSum.sumTotalShiQi.viewXYTemporary[0] == 0 && ComputeSum.sumTotalShiQi.viewXYTemporary[1] == 0) {
                                        ...
                                        ComputeSum.sumTotalShiQi.viewXYTemporary[0] =
                                            showSumShiQiMoney.left
                                        ComputeSum.sumTotalShiQi.viewXYTemporary[1] =
                                            showSumShiQiMoney.top
                                    }
                                }
                            })
