...
enum class EmojiEnum(val key: String, val resId: Int) {
    ...
    Mask ("emoji64", R.drawable.emoji64),
    Rolling("emoji16", R.drawable.emoji16),
    Sweats("emoji54", R.drawable.emoji54),
    Drool("emoji13", R.drawable.emoji13),

    Smirk("emoji44", R.drawable.emoji44),
    Sigh("emoji40", R.drawable.emoji40),
    Facepalm("emoji46", R.drawable.emoji46),
    ...
    Vomit("emoji26", R.drawable.emoji26),
    ...
    Bye("emoji78", R.drawable.emoji78);
