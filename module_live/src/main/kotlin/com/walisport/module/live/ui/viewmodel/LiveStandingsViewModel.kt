...
class LiveStandingsViewModel : BaseViewModel() {
    ...
    fun addCompetitionLiveData() {
        ...
        val table0 = TableBean(0, "", 1, 1, sList)
        val table1 = TableBean(2, "", 1, 1, sList)
        val table2 = TableBean(2, "", 2, 1, sList)
        val table3 = TableBean(3, "", 3, 1, sList)
        val table4 = TableBean(4, "", 4, 1, sList)
