...
class LiveVideoSourceVerticalAdapter(compare: DiffUtil.ItemCallback<LiveVideoBean>) :
    BaseAdapter<LiveVideoBean, LiveVideoSourceVerticalAdapter.LiveVideoSourceViewHolder, ViewBinding>(
        compare
    ) {
