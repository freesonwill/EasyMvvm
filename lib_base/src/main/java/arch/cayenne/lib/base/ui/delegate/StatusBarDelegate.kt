        ...
        when (config.statusBarType) {
            StatusBarEnum.DEFAULT -> {
                ...
                immersionBar.hideBar(BarHide.FLAG_SHOW_BAR) //状态栏显示
                    ...
                    .statusBarDarkFont(true) // Dark icons for status bar
                    .autoStatusBarDarkModeEnable(true, 1.0f)
                immersionBar.init()
                setViewPadding(view, StatusBarConfig.rootViewPaddingTop, view.paddingBottom)
            }
            //全屏
            ...
            StatusBarEnum.TOP_UP -> {
                ...
                immersionBar.init()
                setViewPadding(view, (statusBarHeight+StatusBarConfig.rootViewPaddingTop), navigationBarHeight)
            }
        }
    }
