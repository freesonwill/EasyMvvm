...
class LiveBetSlipInvalidFragment :
    ...
    private fun initRecycler() {
        val adapter =
            arch.cayenne.module.betslip.ui.adapter.LiveBetSlipAdapter(arch.cayenne.module.betslip.data.constants.LiveBetSlipEnum.Invalid)
    ...
    private fun initLoadRefresh() {
        mBinding.refreshLayout.setOnRefreshListener {
            mViewModel.refreshOrder(arch.cayenne.module.betslip.data.constants.LiveBetSlipEnum.Invalid)
        }
        mBinding.refreshLayout.setOnLoadMoreListener {
            mViewModel.loadMoreOrder(arch.cayenne.module.betslip.data.constants.LiveBetSlipEnum.Invalid)
        }
    }
