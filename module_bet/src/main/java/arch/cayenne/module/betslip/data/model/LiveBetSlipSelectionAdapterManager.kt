...
class LiveBetSlipSelectionAdapterManager(binding: ViewBinding, type: arch.cayenne.module.betslip.data.constants.LiveBetSlipEnum) {
    ...
    fun updateView(
        position: Int,
        count: Int,
        expandedEnum: arch.cayenne.module.betslip.data.constants.LiveBetSlipExpandedEnum,
    ...
    private fun managerView(
        ...
        position: Int,
        count: Int,
        expandedEnum: arch.cayenne.module.betslip.data.constants.LiveBetSlipExpandedEnum? = null,
    ...
    private fun configView(
        ...
        group.isVisible = expandedEnum != arch.cayenne.module.betslip.data.constants.LiveBetSlipExpandedEnum.Hide
        llMore.tag = position
        if (expandedEnum != arch.cayenne.module.betslip.data.constants.LiveBetSlipExpandedEnum.Hide) {
            tvMore.text = ContextCompat.getString(
                tvMore.context,
                if (expandedEnum == arch.cayenne.module.betslip.data.constants.LiveBetSlipExpandedEnum.Fold) R.string.see_more else R.string.fold_up
            )
            ivArrow.setImageResource(if (expandedEnum == arch.cayenne.module.betslip.data.constants.LiveBetSlipExpandedEnum.Fold) R.drawable.icon_cricle_arrrow_down else R.drawable.icon_cricle_arrrow_up)
        }
    }
