...
class BetSlipAdapter(type: arch.cayenne.module.betslip.data.constants.BetSlipEnum) :
    BaseAdapter<BetSlipData, BetSlipAdapter.LiveBetSlipViewHolder, ViewBinding>(
        arch.cayenne.module.betslip.ui.compare.BetSlipCompare()
    ) {
    ...
    fun setReserveListener(
        cancelListener: RecyclerItemListener<arch.cayenne.module.betslip.data.model.BetSlipData>,
        modifyListener: RecyclerItemListener<arch.cayenne.module.betslip.data.model.BetSlipData>
    ) {
